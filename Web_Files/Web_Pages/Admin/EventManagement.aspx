...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <link rel="stylesheet" type="text/css" href="../../Styles/Admin/eventManagement.css" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table>
        ...
        <tr>
            ...
            <td class="auto-style1">
                ...
                <asp:HyperLink ID="hlManageCategories" runat="server" NavigateUrl="~/Web_Files/Web_Pages/Admin/ManageCategory.aspx">Manage Categories</asp:HyperLink>
            </td>
        </tr>
        <tr>
            <td colspan="2">
    ...
    <div class="gvEvent">
    <asp:GridView ID="gvEvents" CssClass="gvEvent" runat="server" AutoGenerateColumns="False" DataKeyNames="EventID" OnRowEditing="gvEvents_RowEditing" OnRowDeleting="gvEvents_RowDeleting" OnSelectedIndexChanged="gvEvents_SelectedIndexChanged">
        <Columns>
